...
if (isset($_POST['AñadirAnimal'])) {
  ...
  if($DataBase->insertaAnimal($Nombre,$Edad,$Sexo,$Especie,$Raza,$Color,$Tipopelo,$Tamanyo,$Estado)){
  } else {
...
<body>
  ...
  <form action="insertarAnimal.php" method="post">
   ...
   <input type="submit" name="AñadirAnimal" value="Añadir"> <br>
