...
if (isset($_POST['Enviar'])) {
  ...
  if ($DataBase->insertaVoluntari($nombre,$apellidos,$Edad,$poblacion,$cp,$email,$telefono,$horario)){
  } else {
...
<form id="form1" method="post">
  ...
  <div class="group">
    <input type="text" name='Horario' id='Horario'><span class="highlight"></span><span class="bar"></span>
